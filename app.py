...
REFERENCE_MATERIALS: list[tuple[str, list[tuple[str, str, str]]]] = [
    ...
    ("2024-05 リーク資料", [
        ...
        ("SparkToro Rand Fishkin『An Anonymous Source Shared...』", "https://sparktoro.com/blog/an-anonymous-source-shared-thousands-of-leaked-google-search-api-documents-with-me-everyone-in-seo-should-see-them/",
         "このリークを最初に世に出した本人による一次報告記事。入手経緯と信憑性の裏付けを記載"),
    ]),
    ("DOJ訴訟資料", [
    ...
    ("Search Central Blog", [
        ...
        ("What creators should know about Google's August 2022 helpful content update", "https://developers.google.com/search/blog/2022/08/helpful-content-update",
         "Helpful Content Update (ユーザー第一でないコンテンツを抑制する仕組み) の初回展開を発表した公式記事"),
        ("What web creators should know about our March 2024 core update and new spam policies", "https://developers.google.com/search/blog/2024/03/core-update-spam-policies",
         "Helpful Content System が独立した仕組みからコアランキングシステムに統合されたことを発表した公式記事"),
    ]),
    ("Search Central ドキュメント", [
        ("Search Central ドキュメントトップ", "https://developers.google.com/search/docs?hl=ja",
         "クロール・インデックス・ランキング等、SEO技術情報を網羅する公式ドキュメント集"),
        ("AI Features and Your Website", "https://developers.google.com/search/docs/appearance/ai-features",
         "AI Overviews / AI Modeに表示されるための特別な追加対策は不要と明言する公式一次情報"),
        ("Optimizing for Generative AI Features", "https://developers.google.com/search/docs/fundamentals/ai-optimization-guide",
         "生成AI検索機能 (AI Overviews / AI Mode) 向けの公式最適化ガイド本体"),
        ("Preferred Sources (優先ソース制度)", "https://developers.google.com/search/docs/appearance/preferred-sources",
         "ユーザーが特定サイトを『優先ソース』として選べる新機能の公式説明ページ"),
        ("Creating Helpful, Reliable, People-First Content", "https://developers.google.com/search/docs/fundamentals/creating-helpful-content",
         "Helpful Content (ユーザー第一のコンテンツ) の定義そのものを説明する公式ページ"),
    ]),
    ("Search Central サポート", [
        ("Google SEO Help and Support", "https://developers.google.com/search/help",
         "SEOに関する公式ヘルプ記事・お問い合わせ手段への入口ページ"),
        ("Search Central Community (フォーラム)", "https://support.google.com/webmasters/community?hl=ja",
         "サイト運営者同士がクロール・インデックス・順位等について質問し合う公式ヘルプフォーラム"),
    ]),
    ("Google公式ステータス・SNS", [
        ("Search Status Dashboard (ランキングアップデート状況)", "https://status.search.google.com/summary",
         "進行中・過去のコアアップデート等の開始日・完了日を公式に一覧できるステータスダッシュボード"),
        ("Google Search Central on X (@googlesearchc)", "https://x.com/googlesearchc",
         "Search Central公式X (旧Twitter) アカウント。アップデートの開始・完了等をリアルタイムで発表"),
        ("Google SearchLiaison on X (@searchliaison)", "https://x.com/searchliaison",
         "Googleの検索広報担当 Danny Sullivan が運営する公式Xアカウント。公式見解の速報性が高い"),
        ("Google Search Central LinkedIn", "https://www.linkedin.com/showcase/googlesearchcentral/",
         "Search Central公式LinkedInページ。2024-06開設"),
        ("We're on LinkedIn (finally) — 公式開設アナウンス", "https://developers.google.com/search/blog/2024/06/linkedin-we-are-here",
         "Search Central公式LinkedIn開設 (2024-06-04) を発表したSearch Central Blog記事"),
        ("LinkedIn投稿例: 2026-05コアアップデート発表", "https://www.linkedin.com/posts/googlesearchcentral_google-search-status-dashboard-activity-7463253451183951873-SdbR",
         "Search Central公式LinkedInでの投稿の一例。2026-05コアアップデートのリリースをSearch Status Dashboardと合わせて発表"),
    ]),
]
...
with st.sidebar:
    ...
    st.markdown("**参照する資料**")
    for _ref_category, _ref_items in REFERENCE_MATERIALS:
        with st.expander(_ref_category, expanded=False):
            _ref_rows = []
            for _ref_label, _ref_url, _ref_desc in _ref_items:
                _ref_tooltip = html.escape(_ref_desc, quote=True)
                _ref_rows.append(
                    f'- {_ref_label} '
                    f'<span title="{_ref_tooltip}" style="cursor:help; opacity:0.6;">ⓘ</span> '
                    f'<a href="{_ref_url}" target="_blank" rel="noopener">↗</a>'
                )
            st.markdown("\n".join(_ref_rows), unsafe_allow_html=True)
